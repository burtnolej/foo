...
main:
    GetScheduleDataFromDB clsAppRuntime, iPersonID, QuadSubDataType.Student, _
...
main:
    GetScheduleDataFromDB clsAppRuntime, iPersonID, QuadSubDataType.Student, sPeriod:="1"
