...
class Test_Logger_Member_Function(unittest.TestCase):
    def setUp(self):
        self.log = Log(cacheflag=True, verbosity=20,pad=False)
...
class Test_Log(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Log(verbosity=10,
                       cacheflag=True,logdir=LOGDIR,
                       pidlogname=False,proclogname=False,
                       pad=False,reset="") # this forces the singleton to allow a new instance

    def test_debug(self):
        self.log.log(thisfuncname(),7,msg="foofoobarbar")
        self.assertEquals(self.log.cache[0][2],'DEBUG')
...
class Test_Calling_Class(unittest.TestCase):
    
    def setUp(self):
        self.log = Log(verbosity=10,
                       cacheflag=True,logdir=LOGDIR,
                       pidlogname=True,proclogname=True,
                       echoflag=False,reset="",
                       config = OrderedDict([('now',12),('class',20),('funcname',20),
                                             ('msg',30),('args',30)]))
    ...
    def test_(self):
        ...
        def myfunc(arg1,arg2):
            self.log.log(self,3,msg="this is a test")
...
class Test_Log_Multiple_Entries(unittest.TestCase):
    ...
    def test_1000msg(self):
        ...
        #for i in range(0,len(self.log.cache)):
        #    print self.log.cache[0]
    ...
    def test_1000msg_logger(self):
        ...
        #print self.log.stats[str(pid)]['func1']['no']
        
        for i in range(20):
            self.func1()
            
        print self.log.stats
