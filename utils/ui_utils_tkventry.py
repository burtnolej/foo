...
class BaseTkValidEntry(Frame):
    ...
    def __init__(self,master,name,width,default,var,**kwargs):
        ...
        self.entry= tkwidgetfactory(self,self.var,self,self,
                                    textvariable=self.sv,**kwargs)
...
class TkValidEntry(BaseTkValidEntry):    
    ...
    def __init__(self,master,name,width,default,var):
        ...
        self.ruleslabel = Tklabel(self,text=self.var.name(),width=5,anchor=W,justify=LEFT)

        self.ruleslabel.grid(row=0,column=3,sticky=E)
