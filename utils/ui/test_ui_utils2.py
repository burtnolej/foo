...
class TestTkComboBox(unittest.TestCase):
    ...
    def test_(self):
        ...
        combo = TkCombobox(self.master,self.setmemberp,values=set)
        combo.orig_values = set
        combo.grid(row=0,column=0,sticky=NSEW)

        combo2 = TkCombobox(self.master,self.setmemberp,values=set)
        combo2.orig_values = set
        combo2.grid(row=1,column=0,sticky=NSEW)
        combo2['style']='InFocus.Valid.TCombobox'
          
        combo.update()
        combo.insert(0,'s')
        combo.insert(1,'t')
        
        self.assertEqual(combo.sv.get(),'strawberry')  
        ...
        self.assertEqual(combo2.sv.get(),'passionfruit')  
...
class TestTkWidgetFactory(unittest.TestCase):
    ...
    def test_label(self):
        ...
        widget = tkwidgetfactory(self.master,textro,self.master,self.master,text='foobar')
...
class TestTkWidgetFactoryLabel(unittest.TestCase):
    def setUp(self):
        self.master = Tk()
        self.master.geometry(geometry_get_dict(defaultmaster))
...
class TestWidget(unittest.TestCase):
    ...
    def assertWidgetDimensions(self,widget,percent,**kw):
        ...
        if percent > 0.20 or percent < -0.20:
            raise Exception('do you really want to a percent >20%')
        
        dims = ['height','width','x','y']
        
        #widget.update_idletasks()
        widget.update() # mac seems to like update better than idle_tasks
...
class TestUIGrid2x2even(TestWidget):
    ...
    def setUp(self):
        ...
        # set it to x=5 and y=28 cos thats where mac os puts 0,0 anyway
        self.custommaster = dict(height=52,width=166,x=5,y=28)
    ...
    def test_master(self):
        self.assertWidgetDimensions(self.master,0.2,**self.custommaster)
    ...
    def test_nwbutton(self):
        ...
        self.custommaster['x'] = 0
        self.custommaster['y'] = 0
        
        self.assertWidgetDimensions(self.button1,0.2,**self.custommaster)
    ...
    def test_sebutton(self):
        ...
        self.assertWidgetDimensions(self.button4,0.2,**self.custommaster)
...
class TestUIGrid2x2evenlarge(TestWidget):
    ...
    def test_master(self):
        self.assertWidgetDimensions(self.master,0.2,**defaultmaster)
    ...
    def test_bottomright(self):
        ...
        self.assertWidgetDimensions(self.button4,0.2,**_defaultmaster)
...
class TestUILabelImage(TestWidget):
    ...
    def test_label(self):
        ...
        self.lbl = tkwidgetfactory(self.master,self.mytextalphanumro,self.master,self.master)
        self.lbl.pack(fill=BOTH,expand=1)

        tkwidgetimage_set(self.ic,self.lbl,label,True,**self.image_args)
        
        
        exp_res = get_gif_filename('/Users/burtnolej/Development/pythonapps3/clean/utils/test_gifs',
    ...
    def test_button(self):
        ...
        self.lbl = tkwidgetfactory(self.master,self.bool,self.master,self.master)
        self.lbl.pack(fill=BOTH,expand=1)
    ...
    def setUp(self):
        ...
        class UI(Tk):
            ...
            def __init__(self):
                ...
                image_args = dict(pointsize=24,font='Helvetica',gravity='center',
                ...
                self.tkilg = TkImageLabelGrid(self.master,'grid',self.mytextalphanumro,
                                              self.wmwidth,self.wmheight,
...
class TestTkcomboSetMember(unittest.TestCase):
    def setUp(self):
        ...
        self.setmemberp = SetMemberPartial(name='x{mylist}',set=set)
        self.setmemberp.widgettype = TkGridCombobox
        self.combo = tkwidgetfactory(self.master,self.setmemberp,self.master,self.master,values=set)
...
class TestTkcomboDBSetMember(unittest.TestCase):
    def setUp(self):
        ...
        self.combo = tkwidgetfactory(self.master,self.dbsetmember,self.master,self.master)
        self.combo.grid(row=0,column=0,sticky=NSEW)
    ...
    def test_(self):
        ...
        #elf.master.mainloop()
        self.assertEqual(self.combo.sv.get(),'grape')
...
class TestUINLabel(TestWidget):
    ...
    def test_(self):
        ...
        for i in range(3):
            _widget_sv = self.tknlabel.addlabel()
            self.tknlabel.addspacer(1,'green')
            _widget_sv[0].sv.set(i)
...
if __name__ == "__main__":
    ...
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(TestTkWidgetFactoryLabel))
