...
class TestImageCreateBasic(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.testfiledir = "/Users/burtnolej/Development/pythonapps3/clean/utils/test_gifs"
...
class TestImageCreateMultiSetting(unittest.TestCase):
    ...
    def test_create_1image_red_48_Arial_90_800x200(self):
