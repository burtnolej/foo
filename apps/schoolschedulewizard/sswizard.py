...
class WizardUI(Tk):
    ...
    def __init__(self,dbname,of,refdbname,maxentrycols=3,maxentryrows=4,
        ...
        self.persist_button = Button(buttonpanel,command=self.persist_lesson,text="persist",name="pb")
    ...
    def persist_lesson(self):
        with self.database:
            ...
            for objid in self.of.store['lesson']:
                ...
                log.log(thisfuncname(),9,msg="persisting of obj",objid=objid,exec_str=exec_str,
                        result=result) 
