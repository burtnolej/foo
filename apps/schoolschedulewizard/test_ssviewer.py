...
class Test_Viewer_X_Student_Y_Subject(Test_Viewer_Base):
    ...
    def setUp(self):
        ...
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssloader_conflicts")

    def test_Peter_Stan_subject(self):
                                                                                                       
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'Peter'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'[Activity Period,ELA]'}, [({'value': u'TU'}, {'value': u'830-910'})]]]
        
        self.app.load(saveversion=1,student="Peter",teacher="Amelia")
    ...
    def test_Peter_Stan_subject_count(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'Peter'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'[Activity Period,ELA]'}, [({'value': 1},)]]]
    ...
    def test_inverse(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'[Activity Period,ELA]'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'Peter'}, [({'value': u'TU'}, {'value': u'830-910'})]]]
...
class Test_Viewer_X_Subject_Y_Adult(Test_Viewer_Base):
    ...
    def setUp(self):
        ...
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssviewer_update")
        
        self.dbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_ssviewer_update'
        refdbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_ssviewer_update'
...
class Test_Viewer_All_X_Period_Y_DOW_Constraints_Multivalues(Test_Viewer_Base):
    ...
    def setUp(self):
        #Test_Viewer_Base.setUp(self,"test_ssviewer_update",[("prep5studentClaytonPeriod1WP.csv",5,True)],True)
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssviewer")
        
        self.dbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_ssviewer'
        refdbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_ssviewer'
...
class Test_Viewer_X_Period_Y_DOW(Test_Viewer_Base):
    ...
    def test_Mo_830_910_Peter_adult_subject(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'??'}, {'value': u'Math'})]]]
    ...
    def test_Mo_Peter_adult_subject(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], 
                            [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'??'}, {'value': u'Math'})]]]
    ...
    def test_Mo_830_910_Peter_adult_recordtype(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'??'}, {'value': 'academic'})]]]
    ...
    def test_Mo_830_910_adult_subject(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'Peter'}, {'value': u'??'}), ({'value': u'Coby'}, {'value': u'Amelia'})]]]
    ...
    def test_Mo_830_910_count_groupby(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': 2},)]]]
    ...
    def test_Mo_830_910_adult_subject_no_unknowns(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'Coby'}, {'value': u'Amelia'})]]]
        
        self.app.load(saveversion=1,student="",dow="MO",period="830-910",unknown='N')
...
class Test_Viewer_X_Period_Y_Adult(Test_Viewer_Base):
    ...
    def test_Karolina_Peter_adult_subject(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'Amelia'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'Peter'}, {'value': u'[Activity Period,ELA]'})]]]
    ...
    def test_830_910_Peter_adult_subject(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'??'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'Peter'}, {'value': u'Math'})]]]
...
class Test_Viewer_Conflicts(Test_Viewer_Base):
    ...
    def test_conflicts_only(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'TU'}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'WE'}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'TH'}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'FR'}],
                            [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'value': u'Math'},)], [({'value': u'Activity Period'},), ({'value': u'ELA'},)], [({'value': u'Math'},)], [({'value': u'Student News'},)], [({'value': u'Humanities'},)]]]
...
class Test_Viewer_X_Period_Y_DOW_Formats(Test_Viewer_Base):
    ...
    def test_Mo_830_910_Peter_adult_1attr(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'bgcolor': u'#99ffcc', 'fgcolor': u'#000000', 'value': u'Math'},)]]]
    ...
    def test_Mo_830_910_Peter_adult_2attr(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'MO'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'bgcolor': u'#99ffcc', 'fgcolor': u'#000000', 'value': u'Math'}, {'bgcolor': u'#d3d3d3', 'fgcolor': u'#ffffff', 'value': u'??'})]]]
...
class Test_Viewer_UI_Conflicts(Test_Viewer_Base):
    def setUp(self):
        ...
        files = [(CURRENTDIR+"/"+THISEXEC+"/"+"prep5studentPeterPeriod1.csv",5,True,"5s"),(CURRENTDIR+"/"+THISEXEC+"/"+"prep56new_Amelia_1period.csv",-1,True,"56n")]
    ...
    def test_conflicts_only(self):
        ...
        expected_results = [['', u'MO', u'TU', u'WE', u'TH', u'FR'], 
                            [u'830-910', u'Math', u'(Activity Period)(ELA)', u'Math', u'Student News', u'Humanities']]
...
class Test_Viewer_UI_Conflicts_Report(Test_Viewer_Base):
    def setUp(self):
        ...
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssloader_conflicts",files)
    ...
    def test_(self):
        ...
        expected_results = "^Peter^Jack\n830-910^(Amelia,Activity Period)(Amelia,ELA)^(Amelia,ELA)\n"
...
class Test_Viewer_UI(Test_Viewer_Base):
    ...
    def setUp(self):
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssloader",
                               [(CURRENTDIR+"/"+THISEXEC+"/"+"prep5student.csv",5,True)])
        #Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssloader")
        #Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssviewer")
    ...
    def test_Peter_student_subject(self):
        ...
        expected_results = [['', u'??', u'Paraic', u'[Paraic,Rahul]', u'Amelia', u'Issey'], 
                            [u'1110-1210', u'(Peter,Computer Time)', '', '', '', ''], 
                            [u'910-950', u'(Peter,Core)', '', '', '', ''], 
                            [u'950-1030', '', u'(Peter,Science)', '', '', ''], 
                            [u'1210-1250', u'(Peter,??)', '', u'(Peter,??)', '', ''], 
    ...
    def test_Mo_830_910_count_groupby(self):
        ...
        #expected_results = [['', u'MO'], [u'1030-1110', '16']]
    ...
    def test_Mo_830_910_groupby(self):
        ...
        expected_results = [['', u'MO'], [u'1030-1110', u'(Core,??)(Science,Paraic)(Game Period,Dylan)(ELA,Aaron)(ELA,Amelia)(History,Issey)']]
...
class Test_1row_1col_1subrow_1subcol(Test_Viewer_Base):
    ...
    def setUp(self):
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"1subrow_1subcol")
...
class Test_1row_1col_2subrow_1subcol(Test_Viewer_Base):
    ...
    def setUp(self):
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"2subrow_1subcol")
...
class Test_nrow_ncol_2subrow_1subcol(Test_Viewer_Base):
    ...
    def test_formats(self):
        ...
        self.expected_results = [[{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': ''}, {'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'??'}], [{'bgcolor': u'#ffffff', 'fgcolor': u'#000000', 'value': u'830-910'}, [({'bgcolor': u'#d3d3d3', 'fgcolor': u'#ffffff', 'value': u'Peter'}, {'bgcolor': u'#99ffcc', 'fgcolor': u'#000000', 'value': u'Math'})]]]
        ...
        self.assertListEqual(self.expected_results,results)
...
class Test_Service_nopivot_1lesson(Test_Viewer_Base):
    ...
    def setUp(self):
        ...
        dbname=CURRENTDIR+"/"+THISEXEC+"/"+'service_no_pivot_1lessons'
        refdbname=CURRENTDIR+"/"+THISEXEC+"/"+'service_no_pivot_1lessons'
    ...
    def test_(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'status'}, 
                            ...
                            [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, 
                             ...
                             {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, 
                             ...
                             {'bgcolor': u'#362e37', 'valuetype': 'adult', 'fgcolor': u'#f2e813', 'value': u'Dylan'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Clayton'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'00427CB0'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'4.1.2.37.37'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'subject', 'fgcolor': u'#ffffff', 'value': u'Game Period'}]]
...
class Test_Service_nopivot_2lessons(Test_Viewer_Base):
    ...
    def setUp(self):
        ...
        dbname=CURRENTDIR+"/"+THISEXEC+"/"+'service_no_pivot_2lessons'
        refdbname=CURRENTDIR+"/"+THISEXEC+"/"+'service_no_pivot_2lessons'
    ...
    def test_(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'status'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'substatus'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'recordtype'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'period'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'dow'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'source'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'session'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'adult'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'student'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'id'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'objtype'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'prep'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'userobjid'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'subject'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'MO'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#006600', 'valuetype': 'session', 'fgcolor': u'#00ff00', 'value': u'Amelia.ELA.Monday.100-140'}, {'bgcolor': u'#006600', 'valuetype': 'adult', 'fgcolor': u'#00ff00', 'value': u'Amelia'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Clayton'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'004ACB88'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'7.1.2.6.1'}, {'bgcolor': u'#ffcc99', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'ELA'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#00ff00', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': u'wp'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'140-220'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'MO'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#006600', 'valuetype': 'session', 'fgcolor': u'#00ff00', 'value': u'Amelia.ELA.Monday.140-220'}, {'bgcolor': u'#006600', 'valuetype': 'adult', 'fgcolor': u'#00ff00', 'value': u'Amelia'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Clayton'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'3379671'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'8.1.2.6.1'}, {'bgcolor': u'#ffcc99', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'ELA'}]]
...
class Test_Service_nopivot_17lessons(Test_Viewer_Base):
    ...
    def setUp(self):
        ...
        dbname=CURRENTDIR+"/"+THISEXEC+"/"+'service_no_pivot_17lessons'
        refdbname=CURRENTDIR+"/"+THISEXEC+"/"+'service_no_pivot_17lessons'
    ...
    def test_(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'status'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'substatus'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'recordtype'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'period'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'dow'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'source'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'session'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'adult'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'student'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'id'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'objtype'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'prep'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'userobjid'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'subject'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'1030-1110'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'MO'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.ELA.Monday.1030-1110'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'019C3483'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'4.1.9.1.1'}, {'bgcolor': u'#ffcc99', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'ELA'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'TU'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Activity Period.Tuesday.100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jack'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'058808F5'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'7.2.8.1.9'}, {'bgcolor': u'#cccc00', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'Activity Period'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'WE'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Student News.Wednesday.950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'0475D8EF'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'3.4.9.1.5'}, {'bgcolor': u'#003333', 'valuetype': 'subject', 'fgcolor': u'#ffff99', 'value': u'Student News'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'WE'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.ELA.Wednesday.100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Orig'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'029EE113'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'7.4.4.1.1'}, {'bgcolor': u'#ffcc99', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'ELA'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'TH'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Student News.Thursday.950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Bruno'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'01C1A403'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'3.3.3.1.5'}, {'bgcolor': u'#003333', 'valuetype': 'subject', 'fgcolor': u'#ffff99', 'value': u'Student News'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'TH'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Student News.Thursday.950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Peter'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'014381EB'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'3.3.7.1.5'}, {'bgcolor': u'#003333', 'valuetype': 'subject', 'fgcolor': u'#ffff99', 'value': u'Student News'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'TU'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Activity Period.Tuesday.100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'00A5CC47'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'7.2.9.1.9'}, {'bgcolor': u'#cccc00', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'Activity Period'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'WE'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Student News.Wednesday.950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Clayton'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'4868523'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'3.4.2.1.5'}, {'bgcolor': u'#003333', 'valuetype': 'subject', 'fgcolor': u'#ffff99', 'value': u'Student News'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'1030-1110'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'WE'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.ELA.Wednesday.1030-1110'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'0564B672'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'4.4.9.1.1'}, {'bgcolor': u'#ffcc99', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'ELA'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'TH'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Activity Period.Thursday.950-1030'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'1973804'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'3.3.9.1.9'}, {'bgcolor': u'#cccc00', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'Activity Period'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'MO'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.ELA.Monday.100-140'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Orig'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'02363A8B'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'7.1.4.1.1'}, {'bgcolor': u'#ffcc99', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'ELA'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'220-300'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'TH'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Activity Period.Thursday.220-300'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'022AAB36'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'9.3.9.1.9'}, {'bgcolor': u'#cccc00', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'Activity Period'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'master'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'substatus', 'fgcolor': u'#ffffff', 'value': u'complete'}, {'bgcolor': u'#ff0000', 'valuetype': 'recordtype', 'fgcolor': u'#000000', 'value': 'academic'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'period', 'fgcolor': u'#ffffff', 'value': u'220-300'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'dow', 'fgcolor': u'#ffffff', 'value': u'TH'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'source', 'fgcolor': u'#ffffff', 'value': u'dbinsert'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'session', 'fgcolor': u'#ffffff', 'value': u'Aaron.Activity Period.Thursday.220-300'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'adult', 'fgcolor': u'#ffffff', 'value': u'Aaron'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Orig'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'id', 'fgcolor': u'#ffffff', 'value': u'04F4C865'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'objtype', 'fgcolor': u'#ffffff', 'value': 'lesson'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'prep', 'fgcolor': u'#ffffff', 'value': 5}, {'bgcolor': u'#d3d3d3', 'valuetype': 'userobjid', 'fgcolor': u'#ffffff', 'value': u'9.3.4.1.9'}, {'bgcolor': u'#cccc00', 'valuetype': 'subject', 'fgcolor': u'#000000', 'value': u'Activity Period'}]]
    ...
    def test_setpagelen(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'subject'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'student'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'ELA'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'Activity Period'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jack'}]]
    ...
    def test_setpage(self):
        ...
        expected_results = [[{'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'subject'}, {'bgcolor': u'#ffffff', 'valuetype': 'col', 'fgcolor': u'#000000', 'value': 'student'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'Student News'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Jake'}], [{'bgcolor': u'#ffffff', 'valuetype': 'row', 'fgcolor': u'#000000', 'value': u'ELA'}, {'bgcolor': u'#d3d3d3', 'valuetype': 'student', 'fgcolor': u'#ffffff', 'value': u'Orig'}]]
        schema = dict(xaxis='row',yaxis='col',colnames=list(colnames))
        results = ssviewer_utils.dataset_serialize(grid,formatson=True,schema=schema)
...
class Test_Viewer_Update_Recover(Test_Viewer_Base):
    ...
    def setUp(self):
        Test_Viewer_Base.setUp(self,CURRENTDIR+"/"+THISEXEC+"/"+"test_ssviewer_update_recover")
        
        self.dbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_ssviewer_update_recover'
        refdbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_ssviewer_update_recover'
...
if __name__ == "__main__":
    ...
    # Misc - THIS ONE TAKES A WHILE TO RUN
