...
class Test_newrecord(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_service_new_record'
        self.database = Database(self.dbname)
        self.of = ObjFactory(True)
        self.enums = sswizard_utils.setenums(dow="all",prep=-1,database=self.database)
        self.prepmap = sswizard_utils._loadprepmapper(self.database)
...
class Test_load(unittest.TestCase):
    ...
    def test_(self):
        ...
        expected_results = [['code', 'name', 'enum', 'objtype', 'userobjid'], 
                            [u'1030-1110', u'1030-1110', 0, 'period', u'1030-1110']]
...
class Test_loadref(unittest.TestCase):
    ...
    def test_period(self):
        ...
        expected_results = [['code', 'name', 'enum'], 
                            ...
                            [u'1110', u'1110-1210', u'5'], 
                            [u'1210', u'1210-1250', u'6'], 
                            [u'1310', u'1250-130', u'7'], 
                            [u'1340', u'130-210', u'8'], 
                            [u'1420', u'210-250', u'9'], 
    ...
    def test_student(self):
        ...
        expected_results = [['code', 'name', 'enum', 'prep'], 
...
class Test_list(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dbname=CURRENTDIR+"/"+THISEXEC+"/"+'test_ssviewer_util_list'
        self.database = Database(self.dbname)
        self.of = ObjFactory(True)
...
class Test_refdata(unittest.TestCase):
    ...
    def test_(self):
        ...
        expected_results = {'recordtype': [u'subject', u'wp', u'ap'], 
                            'period': [u'830-910', u'910-950', u'950-1030', u'1030-1110', u'1110-1210', u'1210-1250', u'1250-130', u'130-210', u'210-250', u'250-310'], 
                            'adult': [u'Aaron', u'Stan', u'Rahul', u'Alexa', u'Paraic', u'Amelia', u'Issey', u'??', u'Karolina', u'John', u'Galina', u'Sam', u'Izzy', u'Melissa', u'Thea', u'Jess', u'Samantha', u'Nicole', u'Issey', u'A', u'B', u'C', u'D', u'Moira', u'Patti', u'Dylan', u'Johnny', u'Alyssa', u'Jacki', u'Karolina', u'SONJA', u'Eric', u'Daryl', u'Francisco', u'Alberto', u'Profeshor', u'John Zink', u'Bari'], 'student': [u'Nathaniel', u'Clayton', u'Bruno', u'Orig', u'Stephen', u'Oscar', u'Peter', u'Jack', u'Jake', u'Coby', u'Thomas', u'Yosef', u'Tristan', u'Ashley', u'Simon A', u'Booker', u'OmerC', u'Asher', u'Shane', u'Simon B', u'Mackenzie', u'Nick', u'Lucy', u'Liam', u'Donovan', u'Luke', u'Tris', u'Prep 4'], 
                            'dow': [u'Monday', u'Tuesday', u'Thursday', u'Wednesday', u'Friday'], 
                            'subject': [u'ELA', u'Drama', u'Engineering', u'Math', u'Student News', u'Counseling', u'Science', u'Movement', u'Activity Period', u'Speech', u'History', u'OT', u'Core', u'Chess', u'Computer Time', u'Music', u'??', u'Independent Reading', u'Piano', u'Art', u'STEM', u'Humanities', u'Work Period', u'Math Activity Period', u'Reading', u'Italian', u'Debate', u'Psychology', u'Spanish', u'Psychology Reading', u'Biology', u'Independent Art', u'Supervision', u'Mentorship', u'Quad Cafe', u'Track', u'Game Period', u'IXL', u'Typing']}
        
        
        result =  ssviewer_utils.dataset_refdata(self.database)
