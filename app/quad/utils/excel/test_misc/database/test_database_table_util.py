...
from utils.database.database_table_util import tbl_rows_get, tbl_rows_insert, \
     ...
     dbtblgeneric, tbl_move, tbl_to_xml
...
class TestDBTblToXML(unittest.TestCase):
    ...
    def test_(self):
        ...
        with database:
            tbl_create(database,test_db.tbl_name,test_db.col_defn)
            tbl_rows_insert(database,test_db.tbl_name,test_db.col_name,test_db.tbl_rows)
        ...
        with database:
            ...
            tbl_to_xml(database,test_db.tbl_name,['col_name1','col_name2','col_name3','col_name4'],
                       whereclause,xmlroot=xmlroot)
...
if __name__ == "__main__":
    ...
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(TestDBTblToXML))
